...
INSERT INTO new_pdd (logo, title)
VALUES (
...
INSERT INTO new_pdd_category(title)
...
CREATE SEQUENCE new_pdd_text_ids;
CREATE TABLE new_pdd_text
(
  id INTEGER DEFAULT NEXTVAL('new_pdd_text_ids'),
  category_id INTEGER not null REFERENCES new_pdd_category (id),
  text text
);

-- -- -- -- -- -- -- -- -- --

INSERT INTO new_pdd_text(category_id, text)
